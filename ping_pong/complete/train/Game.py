...
class Window:
    ...
    def run(self):
        ...
        while running:
            ...
            if keys[pygame.K_w]:  # Move the left paddle up
                self.left_paddle.move_up()
            if keys[pygame.K_s]:  # Move the left paddle down
                self.left_paddle.move_down()
            if keys[pygame.K_UP]:  # Move the right paddle up
                self.right_paddle.move_up()
            if keys[pygame.K_DOWN]:  # Move the right paddle down
